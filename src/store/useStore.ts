...
/** localStorage key for the last opened/saved desktop file path. */
...
interface StoreState {
  ...
  /** Last saved file path on the desktop (Tauri) app, for in-place Cmd+S. */
  ...
  /** Remember (and persist) the desktop file path so Cmd+S saves in place and
   *  the app can reopen the file fresh on next launch. */
